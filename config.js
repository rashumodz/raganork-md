...
module.exports = {
    ...
    REJECT_CALLS: convertToBool(process.env.REJECT_CALLS) || tru,
    ...
    BOT_INFO: process.env.BOT_INFO || '𝐍𝐑 𝐑𝐀𝐒𝐇𝐔 𝐌𝐎𝐃𝐙;𝑹𝒂𝒔𝒉𝒖𝑴𝒂𝒏𝒊𝒌𝒂;0;https://i.imgur.com/FH4u9Ho.jpeg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "𝐍𝐑 𝐑𝐀𝐒𝐇𝐔 𝐌𝐎𝐃𝐙",
    BOT_NAME: process.env.BOT_NAME || '𝐍𝐑 𝐑𝐀𝐒𝐇𝐔 𝐌𝐎𝐃𝐙',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭𝐍𝐑 𝐑𝐀𝐒𝐇𝐔 𝐌𝐎𝐃𝐙¹¹ꫂ;𝐍𝐑 𝐑𝐀𝐒𝐇𝐔 𝐌𝐎𝐃𝐙 MD bot;https://i.imgur.com/FH4u9Ho.jpeg' : process.env.AUDIO_DATA,
